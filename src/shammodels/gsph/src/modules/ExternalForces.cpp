...
void shammodels::gsph::modules::ExternalForces<Tvec, SPHKernel>::compute_ext_forces_indep_v() {
    ...
    // here the force of sinks onto SPH particles is computed and added to axyz_ext
...
template<class Tvec, template<class> class SPHKernel>
void shammodels::gsph::modules::ExternalForces<Tvec, SPHKernel>::point_mass_accrete_particles() {
...
template class shammodels::gsph::modules::ExternalForces<f64_3, M4>;
template class shammodels::gsph::modules::ExternalForces<f64_3, M6>;
template class shammodels::gsph::modules::ExternalForces<f64_3, M8>;

template class shammodels::gsph::modules::ExternalForces<f64_3, C2>;
template class shammodels::gsph::modules::ExternalForces<f64_3, C4>;
template class shammodels::gsph::modules::ExternalForces<f64_3, C6>;
