...
auto shammodels::gsph::modules::GeneratorMCDisc<Tvec, SPHKernel>::DiscIterator::next(u64 seed)
    -> DiscOutput {
...
template<class Tvec, template<class> class SPHKernel>
bool shammodels::gsph::modules::GeneratorMCDisc<Tvec, SPHKernel>::is_done() {
    return generator.is_done();
}

template<class Tvec, template<class> class SPHKernel>
shamrock::patch::PatchDataLayer shammodels::gsph::modules::GeneratorMCDisc<Tvec, SPHKernel>::next_n(
    u32 nmax) {
...
template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, M4>;
template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, M6>;
template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, M8>;

template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, C2>;
template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, C4>;
template class shammodels::gsph::modules::GeneratorMCDisc<f64_3, C6>;
