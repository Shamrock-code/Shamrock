...
void shammodels::gsph::modules::SinkParticlesUpdate<Tvec, SPHKernel>::accrete_particles(Tscal dt) {
...
template<class Tvec, template<class> class SPHKernel>
void shammodels::gsph::modules::SinkParticlesUpdate<Tvec, SPHKernel>::predictor_step(Tscal dt) {
...
template<class Tvec, template<class> class SPHKernel>
void shammodels::gsph::modules::SinkParticlesUpdate<Tvec, SPHKernel>::corrector_step(Tscal dt) {
...
template<class Tvec, template<class> class SPHKernel>
void shammodels::gsph::modules::SinkParticlesUpdate<Tvec, SPHKernel>::compute_ext_forces() {
...
template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, M4>;
template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, M6>;
template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, M8>;

template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, C2>;
template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, C4>;
template class shammodels::gsph::modules::SinkParticlesUpdate<f64_3, C6>;
