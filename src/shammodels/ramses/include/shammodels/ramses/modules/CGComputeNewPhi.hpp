...
namespace shammodels::basegodunov::modules {
    ...
    template<class T>
    class NodeComputeNewPhi : public shamrock::solvergraph::INode {

        u32 block_size;
        T alpha;

        public:
        NodeComputeNewPhi(u32 block_size, T alpha) : block_size(block_size), alpha(alpha) {}
        ...
        inline void set_edges(
            ...
            __internal_set_ro_edges({sizes, spans_phi_p});
        ...
        inline virtual std::string _impl_get_label() { return "NodeComputeNewPhi"; };
