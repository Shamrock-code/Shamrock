"""
GSPH Sod Shock Tube with Animated Output
=========================================

This script runs a Godunov SPH (GSPH) Sod shock tube simulation
and generates both VTK files for ParaView and a matplotlib animation.

The Sod shock tube is a standard 1D Riemann problem benchmark.
...
Usage:
    ./shamrock --sycl-cfg 0:0 --rscript gsph_sod_animation.py
"""
...
# Output settings
output_dir = "gsph_sod_output"
vtk_prefix = "gsph_sod"
animation_file = "gsph_sod_animation.gif"
...
print("=" * 70)
print("GSPH Sod Shock Tube Simulation with Animation")
print("=" * 70)
print()
print("Configuration:")
...
cfg.set_riemann_hllc()                    # HLLC Riemann solver
cfg.set_reconstruct_piecewise_constant()  # 1st order reconstruction
cfg.set_eos_adiabatic(gamma)              # Adiabatic EOS
...
final_frame_path = os.path.join(output_dir, "gsph_sod_final.png")
...
print()
print("=" * 70)
print("GSPH Sod Shock Tube Simulation Complete!")
print("=" * 70)
