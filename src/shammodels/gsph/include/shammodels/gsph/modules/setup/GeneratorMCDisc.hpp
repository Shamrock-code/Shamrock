...
namespace shammodels::gsph::modules {
    ...
    class GeneratorMCDisc : public IGSPHSetupNode {
        ...
        IGSPHSetupNode_Dot get_dot_subgraph() { return IGSPHSetupNode_Dot{get_name(), 0, {}}; }
    };

} // namespace shammodels::gsph::modules

template<class Tvec, template<class> class SPHKernel>
class shammodels::gsph::modules::GeneratorMCDisc<Tvec, SPHKernel>::DiscIterator {
