...
namespace shammodels::basegodunov::modules {
    ...
    class NodeJacobiPreconditioner : public shamrock::solvergraph::INode {
        ...
        struct Edges {
            ...
            const shamrock::solvergraph::IFieldSpan<T> &spans_block_cell_sizes;
        ...
        inline void set_edges(
            ...
            std::shared_ptr<shamrock::solvergraph::IFieldSpan<T>> spans_block_cell_sizes,
            std::shared_ptr<shamrock::solvergraph::IFieldSpan<T>> spans_x,
            std::shared_ptr<shamrock::solvergraph::IFieldRefs<T>> spans_y) {
            __internal_set_ro_edges({sizes, spans_block_cell_sizes, spans_x});
        ...
        inline virtual std::string _impl_get_label() { return "NodeJacobiPreconditioner"; };
