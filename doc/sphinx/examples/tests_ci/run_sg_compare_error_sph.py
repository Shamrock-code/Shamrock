...
TOL_HPC_CUBE = {
    ...
    "mm2": {
        ...
        "avg_rel_delta": [0.02809153086497972 - 2e-6, 0.02809153086497972 + 2e-6],
        "min_rel_delta": [0.0007660948531784951 - 2e-7, 0.0007660948531784951 + 2e-7],
        "std_rel_delta": [0.011728053659573516 - 2e-7, 0.011728053659573516 + 2e-7],
    },
    "mm3": {
        "max_rel_delta": [0.053440736724222254 - 4e-7, 0.053440736724222254 + 4e-7],
        "avg_rel_delta": [0.016082633182446748 - 4e-7, 0.016082633182446748 + 4e-7],
        "min_rel_delta": [0.0006196291223064161 - 4e-7, 0.0006196291223064161 + 4e-7],
        "std_rel_delta": [0.007676767861132326 - 4e-7, 0.007676767861132326 + 4e-7],
    },
    "mm4": {
        "max_rel_delta": [0.05833850788436308 - 4e-7, 0.05833850788436308 + 4e-7],
        "avg_rel_delta": [0.014909667170457708 - 4e-7, 0.014909667170457708 + 4e-7],
        "min_rel_delta": [0.000900026203337091 - 4e-7, 0.000900026203337091 + 4e-7],
        "std_rel_delta": [0.007051020680900702 - 4e-7, 0.007051020680900702 + 4e-7],
    },
    "mm5": {
        "max_rel_delta": [0.03130228236510434 - 4e-8, 0.03130228236510434 + 4e-8],
        "avg_rel_delta": [0.005541631318650798 - 4e-8, 0.005541631318650798 + 4e-8],
        "min_rel_delta": [0.00011105937841131173 - 4e-8, 0.00011105937841131173 + 4e-8],
        "std_rel_delta": [0.003575474772831352 - 4e-8, 0.003575474772831352 + 4e-8],
    },
}
