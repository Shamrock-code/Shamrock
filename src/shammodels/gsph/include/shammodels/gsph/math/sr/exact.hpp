...
namespace shammodels::gsph::sr {
    ...
    // =========================================================================
    template<class Tscal>
    inline ExactRiemannResult<Tscal> sr_exact_solver(
        Tscal v_x_L,
        Tscal v_t_L,
        Tscal n_L,
        Tscal P_L,
        ...
        ExactRiemannResult<Tscal> result;
    ...
    // =========================================================================
    // Simplified interface for exact SR Riemann solver
    // =========================================================================
    template<class Tscal>
    inline bool sr_exact_interface(
        Tscal v_x_L,
        Tscal v_t_L,
        Tscal n_L,
        Tscal P_L,
        ...
        ExactRiemannResult<Tscal> result
            = sr_exact_solver(v_x_L, v_t_L, n_L, P_L, v_x_R, v_t_R, n_R, P_R, gamma);
