"""
Problem 1: SR Sod Shock Tube (Kitajima et al. 2025, Section 3.1.1)
==================================================================

CI test matching arXiv:2510.18251v1 Figure 3 (1D_Sod_32_3200vs400)

Initial conditions:
    Left:  (P, n, v^x, v^t) = (1.0, 1.0, 0, 0)
    Right: (P, n, v^x, v^t) = (0.1, 0.125, 0, 0)

Kitajima setup:
    - Equal baryon number ν per particle
    - 3200 particles left, 400 right (8:1 ratio = n_L/n_R)
    - t = 0.35, γ = 5/3
"""
...
print("SR Sod Test (Kitajima Problem 1)")
...
# Uniform spacing, density from pmass (volume-based)
...
# Convert to REST-FRAME n = N/γ for comparison with analytic solution
...
if test_pass:
    print("\n" + "=" * 50)
    print("SR Sod Problem 1: PASSED")
    print("=" * 50)
else:
    print("\n" + "=" * 50)
    print("SR Sod Problem 1: FAILED")
