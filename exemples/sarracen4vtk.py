...
#########################PLOTTING#######################
file = "/Users/ylapeyre/Documents/Shamwork/initdump2.vtk"
...
tilt = np.arccos(-Ly / Lmag)



sdf_ph, sdf_sinks      = sarracen.read_phantom("/Users/ylapeyre/Documents/githubrepos/phantomtests/warp2/warp_00000")
...
ax[1].scatter(bin_mid, tilt, c='r', marker='.')
ax[1].scatter(unit_am_ph[3], tilt_ph, c='k', marker='.', label='phantom')
ax[1].set_title('tilt')

ax[2].scatter(bin_mid, twist, c='r', marker='.')
