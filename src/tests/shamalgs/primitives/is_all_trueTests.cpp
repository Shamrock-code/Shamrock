...
TestStart(Unittest, "shamalgs/primitives/is_all_true_sycl_buffer", test_is_all_true_sycl_buffer, 1) {

    {
        ...
        bool result = shamalgs::is_all_true(buf, size);
        REQUIRE(result);
    }
...
TestStart(Unittest, "shamalgs/primitives/is_all_true_device_buffer", test_is_all_true_device_buffer, 1) {
