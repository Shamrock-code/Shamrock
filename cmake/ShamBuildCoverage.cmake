...
if(CMAKE_BUILD_TYPE STREQUAL "COVERAGE")
    if(NOT DEFINED SHAM_ASSERT_MODE)
        set(SHAM_ASSERT_MODE RUNTIME_ERROR)
        message(STATUS "Setting SHAM_ASSERT_MODE=RUNTIME_ERROR with CMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} (you can force it off).")
    endif()
endif()
