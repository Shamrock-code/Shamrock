...
namespace shammodels::basegodunov::modules {
    ...
    class PCGInit : public shamrock::solvergraph::INode {
        ...
        struct Edges {
            ...
            shamrock::solvergraph::IFieldSpan<Tscal> &spans_phi_pres;
        ...
        inline void set_edges(
            ...
            std::shared_ptr<shamrock::solvergraph::IFieldSpan<Tscal>> spans_phi_pres,
            ...
            __internal_set_rw_edges({spans_phi_res, spans_phi_pres, spans_phi_p});
        }
        ...
        inline virtual std::string _impl_get_label() { return "PCGInit"; };
