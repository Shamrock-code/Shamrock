...
TOL_HPC_CUBE = {
    ...
    "sfmm1": {
        ...
        "avg_rel_delta": [0.05782934468995147 - 1e-15, 0.05782934468995147 + 1e-15],
        "min_rel_delta": [0.0013277688426936505 - 1e-15, 0.0013277688426936505 + 1e-15],
        "std_rel_delta": [0.03078712426421105 - 1e-15, 0.03078712426421105 + 1e-15],
    },
    "sfmm2": {
        "max_rel_delta": [0.03804965294061554 - 1e-15, 0.03804965294061554 + 1e-15],
        "avg_rel_delta": [0.011068506783910114 - 1e-15, 0.011068506783910114 + 1e-15],
        "min_rel_delta": [0.0005623871943121567 - 1e-15, 0.0005623871943121567 + 1e-15],
        "std_rel_delta": [0.005375924880946539 - 1e-15, 0.005375924880946539 + 1e-15],
    },
    "sfmm3": {
        "max_rel_delta": [0.01693824120108178 - 1e-15, 0.01693824120108178 + 1e-15],
        "avg_rel_delta": [0.004724856483131658 - 1e-15, 0.004724856483131658 + 1e-15],
        "min_rel_delta": [0.00011119860215853415 - 1e-15, 0.00011119860215853415 + 1e-15],
        "std_rel_delta": [0.0026448823012749684 - 1e-15, 0.0026448823012749684 + 1e-15],
    },
    "sfmm4": {
        "max_rel_delta": [0.011356406701671626 - 1e-15, 0.011356406701671626 + 1e-15],
        "avg_rel_delta": [0.0022876264690043753 - 1e-15, 0.0022876264690043753 + 1e-15],
        "min_rel_delta": [5.847968796399966e-05 - 1e-15, 5.847968796399966e-05 + 1e-15],
        "std_rel_delta": [0.0015169740765526084 - 1e-15, 0.0015169740765526084 + 1e-15],
    },
    "sfmm5": {
        "max_rel_delta": [0.010203458622545465 - 1e-15, 0.010203458622545465 + 1e-15],
        "avg_rel_delta": [0.0014135757954817333 - 1e-15, 0.0014135757954817333 + 1e-15],
        "min_rel_delta": [3.503562542652889e-05 - 1e-15, 3.503562542652889e-05 + 1e-15],
        "std_rel_delta": [0.001217910806477318 - 1e-15, 0.001217910806477318 + 1e-15],
    },
}
