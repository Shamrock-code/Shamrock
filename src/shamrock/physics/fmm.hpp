...
class GreenFuncGravCartesian{public:
    inline static SymTensorCollection<T, low_order,high_order> get_der_tensors(sycl::vec<T,3> r);
};


template<class T>
class GreenFuncGravCartesian <T,0,5>{public:
    inline static SymTensorCollection<T, 0,5> get_der_tensors(sycl::vec<T,3> r){
        T r1 = r.x();
        T r2 = r.y();
        T r3 = r.z();
        ...
        return SymTensorCollection<T,0,5>{
            D0,D1,D2,D3,D4,D5
        };
    }
};
...
class GreenFuncGravCartesian <T,0,4>{public:
    inline static SymTensorCollection<T, 0,4> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
    ...
    return SymTensorCollection<T,0,4>{
        D0,D1,D2,D3,D4
    };
}
};
...
class GreenFuncGravCartesian <T,0,3>{public:
    inline static SymTensorCollection<T, 0,3> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
    ...
    return SymTensorCollection<T,0,3>{
        D0,D1,D2,D3
    };
}
};
...
class GreenFuncGravCartesian <T,0,2>{public:
    inline static SymTensorCollection<T, 0,2> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
    ...
    return SymTensorCollection<T,0,2>{
        D0,D1,D2
    };
}
};
...
class GreenFuncGravCartesian <T,0,0>{public:
    inline static SymTensorCollection<T, 0,0> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
    ...
    return SymTensorCollection<T,0,0>{
        D0
    };
}
};
...
template<class T>
class GreenFuncGravCartesian <T,1,5>{public:
    inline static SymTensorCollection<T, 1,5> get_der_tensors(sycl::vec<T,3> r){
        T r1 = r.x();
        T r2 = r.y();
        T r3 = r.z();
...
template<class T>
class GreenFuncGravCartesian <T,1,4>{public:
    inline static SymTensorCollection<T, 1,4> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
...
template<class T>
class GreenFuncGravCartesian <T,1,3>{public:
    inline static SymTensorCollection<T, 1,3> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
...
template<class T>
class GreenFuncGravCartesian <T,1,2>{public:
    inline static SymTensorCollection<T, 1,2> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
...
template<class T>
class GreenFuncGravCartesian <T,1,1>{public:
    inline static SymTensorCollection<T, 1,1> get_der_tensors(sycl::vec<T,3> r){
    T r1 = r.x();
    T r2 = r.y();
    T r3 = r.z();
    ...
    return SymTensorCollection<T,1,1>{
        D1
    };
}
};
...
template<class T, u32 low_order, u32 high_order>
inline SymTensorCollection<T,low_order,high_order> get_M_mat(SymTensorCollection<T,low_order,high_order> & D, SymTensorCollection<T,low_order,high_order> & Q);


template<class T>
inline SymTensorCollection<T,0,5> get_M_mat(SymTensorCollection<T,0,5> & D, SymTensorCollection<T,0,5> & Q){
    T & TD0 = D.t0;
...
template<class T>
inline SymTensorCollection<T,0,4> get_M_mat(SymTensorCollection<T,0,4> & D, SymTensorCollection<T,0,4> & Q){
    T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
    SymTensor3d_3<T> & TD3 = D.t3;
...
template<class T>
inline SymTensorCollection<T,0,3> get_M_mat(SymTensorCollection<T,0,3> & D, SymTensorCollection<T,0,3> & Q){
    T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
    SymTensor3d_3<T> & TD3 = D.t3;
...
template<class T>
inline SymTensorCollection<T,0,2> get_M_mat(SymTensorCollection<T,0,2> & D, SymTensorCollection<T,0,2> & Q){
    T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
...
template<class T>
inline SymTensorCollection<T,0,1> get_M_mat(SymTensorCollection<T,0,1> & D, SymTensorCollection<T,0,1> & Q){
    T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
...
template<class T>
inline SymTensorCollection<T,0,0> get_M_mat(SymTensorCollection<T,0,0> & D, SymTensorCollection<T,0,0> & Q){
    T & TD0 = D.t0;
...
inline SymTensorCollection<T,1,high_order+1> get_dM_mat(SymTensorCollection<T,1,high_order+1> & D, SymTensorCollection<T,0,high_order> & Q);


template<class T>
inline SymTensorCollection<T,1,5> get_dM_mat(SymTensorCollection<T,1,5> & D, SymTensorCollection<T,0,4> & Q){
    //T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
    SymTensor3d_3<T> & TD3 = D.t3;
    ...
    auto M_1 = TD1 * TQ0 + TD2 * TQ1 + (TD3 * TQ2)*_1i2 + (TD4 * TQ3)*_1i6 + (TD5 * TQ4)*_1i24;
...
template<class T>
inline SymTensorCollection<T,1,4> get_dM_mat(SymTensorCollection<T,1,4> & D, SymTensorCollection<T,0,3> & Q){
    //T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
    SymTensor3d_3<T> & TD3 = D.t3;
...
template<class T>
inline SymTensorCollection<T,1,3> get_dM_mat(SymTensorCollection<T,1,3> & D, SymTensorCollection<T,0,2> & Q){
    //T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
    SymTensor3d_3<T> & TD3 = D.t3;
...
template<class T>
inline SymTensorCollection<T,1,2> get_dM_mat(SymTensorCollection<T,1,2> & D, SymTensorCollection<T,0,1> & Q){
    //T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
    SymTensor3d_2<T> & TD2 = D.t2;
...
template<class T>
inline SymTensorCollection<T,1,1> get_dM_mat(SymTensorCollection<T,1,1> & D, SymTensorCollection<T,0,0> & Q){
    //T & TD0 = D.t0;
    SymTensor3d_1<T> & TD1 = D.t1;
...
template<class T, u32 low_order, u32 high_order>
inline SymTensorCollection<T,low_order,high_order> offset_multipole(
    const SymTensorCollection<T,low_order,high_order> & Q_old,
    const sycl::vec<T,3> & offset);

template<class T>
inline SymTensorCollection<T,0,5> offset_multipole(
    const SymTensorCollection<T,0,5> & Q,
    const sycl::vec<T,3> & offset){
    ...
    //symbolic Qn4 : T4_\mu\nu\delta\epsilon = d_\mu * T3_\nu\delta\epsilon + d_\delta *(T3_\mu\epsilon\nu - d_\mu * T2_\epsilon\nu ) + d2_\epsilon\nu *Q2_\delta\mu + d_\epsilon *Q3_\nu\delta\mu  + d_\nu  *Q3_\delta\epsilon\mu + Q4_\mu\nu\delta\epsilon
    
    auto Qn4 = SymTensor3d_4<T>{
        d.t1.v_0 * Qn3.v_000 + d.t1.v_0 *(Qn3.v_000 - d.t1.v_0 * Qn2.v_00 ) + d.t2.v_00 *Q.t2.v_00 + d.t1.v_0 *Q.t3.v_000  + d.t1.v_0  *Q.t3.v_000 + Q.t4.v_0000,
        d.t1.v_0 * Qn3.v_001 + d.t1.v_0 *(Qn3.v_001 - d.t1.v_0 * Qn2.v_01 ) + d.t2.v_01 *Q.t2.v_00 + d.t1.v_1 *Q.t3.v_000  + d.t1.v_0  *Q.t3.v_001 + Q.t4.v_0001,
        d.t1.v_0 * Qn3.v_002 + d.t1.v_0 *(Qn3.v_002 - d.t1.v_0 * Qn2.v_02 ) + d.t2.v_02 *Q.t2.v_00 + d.t1.v_2 *Q.t3.v_000  + d.t1.v_0  *Q.t3.v_002 + Q.t4.v_0002,
        d.t1.v_0 * Qn3.v_011 + d.t1.v_1 *(Qn3.v_001 - d.t1.v_0 * Qn2.v_01 ) + d.t2.v_01 *Q.t2.v_01 + d.t1.v_1 *Q.t3.v_001  + d.t1.v_0  *Q.t3.v_011 + Q.t4.v_0011,
        d.t1.v_0 * Qn3.v_012 + d.t1.v_1 *(Qn3.v_002 - d.t1.v_0 * Qn2.v_02 ) + d.t2.v_02 *Q.t2.v_01 + d.t1.v_2 *Q.t3.v_001  + d.t1.v_0  *Q.t3.v_012 + Q.t4.v_0012,
        d.t1.v_0 * Qn3.v_022 + d.t1.v_2 *(Qn3.v_002 - d.t1.v_0 * Qn2.v_02 ) + d.t2.v_02 *Q.t2.v_02 + d.t1.v_2 *Q.t3.v_002  + d.t1.v_0  *Q.t3.v_022 + Q.t4.v_0022,
        d.t1.v_0 * Qn3.v_111 + d.t1.v_1 *(Qn3.v_011 - d.t1.v_0 * Qn2.v_11 ) + d.t2.v_11 *Q.t2.v_01 + d.t1.v_1 *Q.t3.v_011  + d.t1.v_1  *Q.t3.v_011 + Q.t4.v_0111,
        d.t1.v_0 * Qn3.v_112 + d.t1.v_1 *(Qn3.v_012 - d.t1.v_0 * Qn2.v_12 ) + d.t2.v_12 *Q.t2.v_01 + d.t1.v_2 *Q.t3.v_011  + d.t1.v_1  *Q.t3.v_012 + Q.t4.v_0112,
        d.t1.v_0 * Qn3.v_122 + d.t1.v_2 *(Qn3.v_012 - d.t1.v_0 * Qn2.v_12 ) + d.t2.v_12 *Q.t2.v_02 + d.t1.v_2 *Q.t3.v_012  + d.t1.v_1  *Q.t3.v_022 + Q.t4.v_0122,
        d.t1.v_0 * Qn3.v_222 + d.t1.v_2 *(Qn3.v_022 - d.t1.v_0 * Qn2.v_22 ) + d.t2.v_22 *Q.t2.v_02 + d.t1.v_2 *Q.t3.v_022  + d.t1.v_2  *Q.t3.v_022 + Q.t4.v_0222,
        d.t1.v_1 * Qn3.v_111 + d.t1.v_1 *(Qn3.v_111 - d.t1.v_1 * Qn2.v_11 ) + d.t2.v_11 *Q.t2.v_11 + d.t1.v_1 *Q.t3.v_111  + d.t1.v_1  *Q.t3.v_111 + Q.t4.v_1111,
        d.t1.v_1 * Qn3.v_112 + d.t1.v_1 *(Qn3.v_112 - d.t1.v_1 * Qn2.v_12 ) + d.t2.v_12 *Q.t2.v_11 + d.t1.v_2 *Q.t3.v_111  + d.t1.v_1  *Q.t3.v_112 + Q.t4.v_1112,
        d.t1.v_1 * Qn3.v_122 + d.t1.v_2 *(Qn3.v_112 - d.t1.v_1 * Qn2.v_12 ) + d.t2.v_12 *Q.t2.v_12 + d.t1.v_2 *Q.t3.v_112  + d.t1.v_1  *Q.t3.v_122 + Q.t4.v_1122,
        d.t1.v_1 * Qn3.v_222 + d.t1.v_2 *(Qn3.v_122 - d.t1.v_1 * Qn2.v_22 ) + d.t2.v_22 *Q.t2.v_12 + d.t1.v_2 *Q.t3.v_122  + d.t1.v_2  *Q.t3.v_122 + Q.t4.v_1222,
        d.t1.v_2 * Qn3.v_222 + d.t1.v_2 *(Qn3.v_222 - d.t1.v_2 * Qn2.v_22 ) + d.t2.v_22 *Q.t2.v_22 + d.t1.v_2 *Q.t3.v_222  + d.t1.v_2  *Q.t3.v_222 + Q.t4.v_2222
    };

    // symbolic Qn5 : {T5}_{\mu\nu\delta\epsilon\sigma} =  d_\mu  T4_\nu\delta\epsilon\sigma  + d_\nu ( T4_\mu\delta\epsilon\sigma  - d_\mu  T3_\delta\epsilon\sigma ) + Q2_\mu\nu d3_\delta\epsilon\sigma +Q3_\mu\nu\sigma d2_\delta\epsilon +Q3_\mu\nu\delta d2_\epsilon\sigma +Q4_\mu\nu\delta\sigma d_\epsilon +Q3_\mu\nu\epsilon d2_\delta\sigma +Q4_\mu\nu\epsilon\sigma d_\delta +Q4_\mu\nu\delta\epsilon d_\sigma +Q5_\mu\nu\delta\epsilon\sigma

    auto Qn5 = SymTensor3d_5<T>{
        d.t1.v_0  *Qn4.v_0000  + d.t1.v_0 *( Qn4.v_0000  - d.t1.v_0 * Qn3.v_000 ) + Q.t2.v_00 *d.t3.v_000 +Q.t3.v_000 *d.t2.v_00 +Q.t3.v_000 *d.t2.v_00 +Q.t4.v_0000 *d.t1.v_0 +Q.t3.v_000 *d.t2.v_00 +Q.t4.v_0000 *d.t1.v_0 +Q.t4.v_0000* d.t1.v_0 +Q.t5.v_00000,
        d.t1.v_0  *Qn4.v_0001  + d.t1.v_0 *( Qn4.v_0001  - d.t1.v_0 * Qn3.v_001 ) + Q.t2.v_00 *d.t3.v_001 +Q.t3.v_001 *d.t2.v_00 +Q.t3.v_000 *d.t2.v_01 +Q.t4.v_0001 *d.t1.v_0 +Q.t3.v_000 *d.t2.v_01 +Q.t4.v_0001 *d.t1.v_0 +Q.t4.v_0000* d.t1.v_1 +Q.t5.v_00001,
        d.t1.v_0  *Qn4.v_0002  + d.t1.v_0 *( Qn4.v_0002  - d.t1.v_0 * Qn3.v_002 ) + Q.t2.v_00 *d.t3.v_002 +Q.t3.v_002 *d.t2.v_00 +Q.t3.v_000 *d.t2.v_02 +Q.t4.v_0002 *d.t1.v_0 +Q.t3.v_000 *d.t2.v_02 +Q.t4.v_0002 *d.t1.v_0 +Q.t4.v_0000* d.t1.v_2 +Q.t5.v_00002,
        d.t1.v_0  *Qn4.v_0011  + d.t1.v_0 *( Qn4.v_0011  - d.t1.v_0 * Qn3.v_011 ) + Q.t2.v_00 *d.t3.v_011 +Q.t3.v_001 *d.t2.v_01 +Q.t3.v_000 *d.t2.v_11 +Q.t4.v_0001 *d.t1.v_1 +Q.t3.v_001 *d.t2.v_01 +Q.t4.v_0011 *d.t1.v_0 +Q.t4.v_0001* d.t1.v_1 +Q.t5.v_00011,
        d.t1.v_0  *Qn4.v_0012  + d.t1.v_0 *( Qn4.v_0012  - d.t1.v_0 * Qn3.v_012 ) + Q.t2.v_00 *d.t3.v_012 +Q.t3.v_002 *d.t2.v_01 +Q.t3.v_000 *d.t2.v_12 +Q.t4.v_0002 *d.t1.v_1 +Q.t3.v_001 *d.t2.v_02 +Q.t4.v_0012 *d.t1.v_0 +Q.t4.v_0001* d.t1.v_2 +Q.t5.v_00012,
        d.t1.v_0  *Qn4.v_0022  + d.t1.v_0 *( Qn4.v_0022  - d.t1.v_0 * Qn3.v_022 ) + Q.t2.v_00 *d.t3.v_022 +Q.t3.v_002 *d.t2.v_02 +Q.t3.v_000 *d.t2.v_22 +Q.t4.v_0002 *d.t1.v_2 +Q.t3.v_002 *d.t2.v_02 +Q.t4.v_0022 *d.t1.v_0 +Q.t4.v_0002* d.t1.v_2 +Q.t5.v_00022,
        d.t1.v_0  *Qn4.v_0111  + d.t1.v_0 *( Qn4.v_0111  - d.t1.v_0 * Qn3.v_111 ) + Q.t2.v_00 *d.t3.v_111 +Q.t3.v_001 *d.t2.v_11 +Q.t3.v_001 *d.t2.v_11 +Q.t4.v_0011 *d.t1.v_1 +Q.t3.v_001 *d.t2.v_11 +Q.t4.v_0011 *d.t1.v_1 +Q.t4.v_0011* d.t1.v_1 +Q.t5.v_00111,
        d.t1.v_0  *Qn4.v_0112  + d.t1.v_0 *( Qn4.v_0112  - d.t1.v_0 * Qn3.v_112 ) + Q.t2.v_00 *d.t3.v_112 +Q.t3.v_002 *d.t2.v_11 +Q.t3.v_001 *d.t2.v_12 +Q.t4.v_0012 *d.t1.v_1 +Q.t3.v_001 *d.t2.v_12 +Q.t4.v_0012 *d.t1.v_1 +Q.t4.v_0011* d.t1.v_2 +Q.t5.v_00112,
        d.t1.v_0  *Qn4.v_0122  + d.t1.v_0 *( Qn4.v_0122  - d.t1.v_0 * Qn3.v_122 ) + Q.t2.v_00 *d.t3.v_122 +Q.t3.v_002 *d.t2.v_12 +Q.t3.v_001 *d.t2.v_22 +Q.t4.v_0012 *d.t1.v_2 +Q.t3.v_002 *d.t2.v_12 +Q.t4.v_0022 *d.t1.v_1 +Q.t4.v_0012* d.t1.v_2 +Q.t5.v_00122,
        d.t1.v_0  *Qn4.v_0222  + d.t1.v_0 *( Qn4.v_0222  - d.t1.v_0 * Qn3.v_222 ) + Q.t2.v_00 *d.t3.v_222 +Q.t3.v_002 *d.t2.v_22 +Q.t3.v_002 *d.t2.v_22 +Q.t4.v_0022 *d.t1.v_2 +Q.t3.v_002 *d.t2.v_22 +Q.t4.v_0022 *d.t1.v_2 +Q.t4.v_0022* d.t1.v_2 +Q.t5.v_00222,
        d.t1.v_0  *Qn4.v_1111  + d.t1.v_1 *( Qn4.v_0111  - d.t1.v_0 * Qn3.v_111 ) + Q.t2.v_01 *d.t3.v_111 +Q.t3.v_011 *d.t2.v_11 +Q.t3.v_011 *d.t2.v_11 +Q.t4.v_0111 *d.t1.v_1 +Q.t3.v_011 *d.t2.v_11 +Q.t4.v_0111 *d.t1.v_1 +Q.t4.v_0111* d.t1.v_1 +Q.t5.v_01111,
        d.t1.v_0  *Qn4.v_1112  + d.t1.v_1 *( Qn4.v_0112  - d.t1.v_0 * Qn3.v_112 ) + Q.t2.v_01 *d.t3.v_112 +Q.t3.v_012 *d.t2.v_11 +Q.t3.v_011 *d.t2.v_12 +Q.t4.v_0112 *d.t1.v_1 +Q.t3.v_011 *d.t2.v_12 +Q.t4.v_0112 *d.t1.v_1 +Q.t4.v_0111* d.t1.v_2 +Q.t5.v_01112,
        d.t1.v_0  *Qn4.v_1122  + d.t1.v_1 *( Qn4.v_0122  - d.t1.v_0 * Qn3.v_122 ) + Q.t2.v_01 *d.t3.v_122 +Q.t3.v_012 *d.t2.v_12 +Q.t3.v_011 *d.t2.v_22 +Q.t4.v_0112 *d.t1.v_2 +Q.t3.v_012 *d.t2.v_12 +Q.t4.v_0122 *d.t1.v_1 +Q.t4.v_0112* d.t1.v_2 +Q.t5.v_01122,
        d.t1.v_0  *Qn4.v_1222  + d.t1.v_1 *( Qn4.v_0222  - d.t1.v_0 * Qn3.v_222 ) + Q.t2.v_01 *d.t3.v_222 +Q.t3.v_012 *d.t2.v_22 +Q.t3.v_012 *d.t2.v_22 +Q.t4.v_0122 *d.t1.v_2 +Q.t3.v_012 *d.t2.v_22 +Q.t4.v_0122 *d.t1.v_2 +Q.t4.v_0122* d.t1.v_2 +Q.t5.v_01222,
        d.t1.v_0  *Qn4.v_2222  + d.t1.v_2 *( Qn4.v_0222  - d.t1.v_0 * Qn3.v_222 ) + Q.t2.v_02 *d.t3.v_222 +Q.t3.v_022 *d.t2.v_22 +Q.t3.v_022 *d.t2.v_22 +Q.t4.v_0222 *d.t1.v_2 +Q.t3.v_022 *d.t2.v_22 +Q.t4.v_0222 *d.t1.v_2 +Q.t4.v_0222* d.t1.v_2 +Q.t5.v_02222,
        d.t1.v_1  *Qn4.v_1111  + d.t1.v_1 *( Qn4.v_1111  - d.t1.v_1 * Qn3.v_111 ) + Q.t2.v_11 *d.t3.v_111 +Q.t3.v_111 *d.t2.v_11 +Q.t3.v_111 *d.t2.v_11 +Q.t4.v_1111 *d.t1.v_1 +Q.t3.v_111 *d.t2.v_11 +Q.t4.v_1111 *d.t1.v_1 +Q.t4.v_1111* d.t1.v_1 +Q.t5.v_11111,
        d.t1.v_1  *Qn4.v_1112  + d.t1.v_1 *( Qn4.v_1112  - d.t1.v_1 * Qn3.v_112 ) + Q.t2.v_11 *d.t3.v_112 +Q.t3.v_112 *d.t2.v_11 +Q.t3.v_111 *d.t2.v_12 +Q.t4.v_1112 *d.t1.v_1 +Q.t3.v_111 *d.t2.v_12 +Q.t4.v_1112 *d.t1.v_1 +Q.t4.v_1111* d.t1.v_2 +Q.t5.v_11112,
        d.t1.v_1  *Qn4.v_1122  + d.t1.v_1 *( Qn4.v_1122  - d.t1.v_1 * Qn3.v_122 ) + Q.t2.v_11 *d.t3.v_122 +Q.t3.v_112 *d.t2.v_12 +Q.t3.v_111 *d.t2.v_22 +Q.t4.v_1112 *d.t1.v_2 +Q.t3.v_112 *d.t2.v_12 +Q.t4.v_1122 *d.t1.v_1 +Q.t4.v_1112* d.t1.v_2 +Q.t5.v_11122,
        d.t1.v_1  *Qn4.v_1222  + d.t1.v_1 *( Qn4.v_1222  - d.t1.v_1 * Qn3.v_222 ) + Q.t2.v_11 *d.t3.v_222 +Q.t3.v_112 *d.t2.v_22 +Q.t3.v_112 *d.t2.v_22 +Q.t4.v_1122 *d.t1.v_2 +Q.t3.v_112 *d.t2.v_22 +Q.t4.v_1122 *d.t1.v_2 +Q.t4.v_1122* d.t1.v_2 +Q.t5.v_11222,
        d.t1.v_1  *Qn4.v_2222  + d.t1.v_2 *( Qn4.v_1222  - d.t1.v_1 * Qn3.v_222 ) + Q.t2.v_12 *d.t3.v_222 +Q.t3.v_122 *d.t2.v_22 +Q.t3.v_122 *d.t2.v_22 +Q.t4.v_1222 *d.t1.v_2 +Q.t3.v_122 *d.t2.v_22 +Q.t4.v_1222 *d.t1.v_2 +Q.t4.v_1222* d.t1.v_2 +Q.t5.v_12222,
        d.t1.v_2  *Qn4.v_2222  + d.t1.v_2 *( Qn4.v_2222  - d.t1.v_2 * Qn3.v_222 ) + Q.t2.v_22 *d.t3.v_222 +Q.t3.v_222 *d.t2.v_22 +Q.t3.v_222 *d.t2.v_22 +Q.t4.v_2222 *d.t1.v_2 +Q.t3.v_222 *d.t2.v_22 +Q.t4.v_2222 *d.t1.v_2 +Q.t4.v_2222* d.t1.v_2 +Q.t5.v_22222
    };
...
template<class T>
inline SymTensorCollection<T,0,4> offset_multipole(
    const SymTensorCollection<T,0,4> & Q,
    const sycl::vec<T,3> & offset){
