...
namespace shammodels::sph::modules {
    ...
    template<class Tvec, template<class> class SPHKernel, class TSolverConfig, class TSetupNodeBase>
    class GeneratorMCDisc : public TSetupNodeBase {
        using Tscal              = shambase::VecComponent<Tvec>;
        static constexpr u32 dim = shambase::VectorProperties<Tvec>::dimension;
        using Kernel             = SPHKernel<Tscal>;

        using Config = TSolverConfig<Tvec, SPHKernel>;
...
template<class Tvec, template<class> class SPHKernel, class TConfig, class TSetupNodeBase>
class shammodels::common::GeneratorMCDisc<Tvec, SPHKernel, TConfig, TSetupNodeBase>::DiscIterator {
