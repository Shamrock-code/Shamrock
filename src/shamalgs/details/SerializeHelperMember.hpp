...
namespace shamalgs::details {
    ...
    template<class T>
    class SerializeHelperMember {public:
    ...
    template<class T>
    class SerializeHelperMember<sycl::vec<T, 2>> {public:
    ...
    template<class T>
    class SerializeHelperMember<sycl::vec<T, 3>> {public:
    ...
    template<class T>
    class SerializeHelperMember<sycl::vec<T, 4>> {public:
    ...
    template<class T>
    class SerializeHelperMember<sycl::vec<T, 8>> {public:
    ...
    template<class T>
    class SerializeHelperMember<sycl::vec<T, 16>> {public:
