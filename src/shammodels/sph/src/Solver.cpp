...
void shammodels::sph::Solver<Tvec, Kern>::init_solver_graph() {
    ...
    if (dosubstepping) {
        ...
        auto make_half_step_sequence = [&](std::string prefix) {
...

            {
                ...
                shambase::get_check_ref(half_step_vxyz)
                    .set_edges(
                        solver_graph.get_edge_ptr<IDataEdge<Tscal>>("sph_dt_half"),
                        solver_graph.get_edge_ptr<FieldRefs<Tvec>>("axyz_sph"),
                        solver_graph.get_edge_ptr<Indexes<u32>>("part_counts"),
                        solver_graph.get_edge_ptr<FieldRefs<Tvec>>("vxyz"));
        ...
        //////////////// do_substep ///////////////
        // first, prepare the pointers to necessary modes
        auto do_foward_euler_vxyz_ptr = solver_graph.register_node(
            "do_foward_euler_vxyz_ptr", shammodels::common::modules::ForwardEuler<Tvec>{});
        shambase::get_check_ref(do_foward_euler_vxyz_ptr)
            .set_edges(
                solver_graph.get_edge_ptr<IDataEdge<Tscal>>("dt_ext_half"),
                solver_graph.get_edge_ptr<FieldRefs<Tvec>>("axyz_ext"),
                solver_graph.get_edge_ptr<Indexes<u32>>("part_counts"),
                solver_graph.get_edge_ptr<FieldRefs<Tvec>>("vxyz"));

        auto do_foward_euler_u_ptr = solver_graph.register_node(
            "do_foward_euler_u_ptr", shammodels::common::modules::ForwardEuler<Tvec>{});
        shambase::get_check_ref(do_foward_euler_u_ptr)
            .set_edges(
                solver_graph.get_edge_ptr<IDataEdge<Tscal>>("dt_ext_half"),
                solver_graph.get_edge_ptr<FieldRefs<Tvec>>("du"),
                solver_graph.get_edge_ptr<Indexes<u32>>("part_counts"),
                solver_graph.get_edge_ptr<FieldRefs<Tvec>>("u"));

        auto do_foward_euler_xyz_ptr = solver_graph.register_node(
            "do_foward_euler_xyz_ptr", shammodels::common::modules::ForwardEuler<Tvec>{});
        shambase::get_check_ref(do_foward_euler_xyz_ptr)
            .set_edges(
                solver_graph.get_edge_ptr<IDataEdge<Tscal>>("dt_ext_half"),
                solver_graph.get_edge_ptr<FieldRefs<Tvec>>("vxyz"),
                solver_graph.get_edge_ptr<Indexes<u32>>("part_counts"),
        ...
        auto make_substeps = [&](std::string prefix) {
            std::vector<std::shared_ptr<shamrock::solvergraph::INode>> substeps;
            {
                auto substeps = solver_graph.register_node(
                    "substeps",
                    shammodels::sph::modules::Substepping<Tvec, Kern>{
                        solver_config,
                        context,
                        do_foward_euler_vxyz_ptr,
                        do_foward_euler_u_ptr,
                        do_foward_euler_xyz_ptr});
                shambase::get_check_ref(substeps).set_edges(
                    solver_graph.get_edge_ptr<IDataEdge<Tscal>>("t"),
                    solver_graph.get_edge_ptr<IDataEdge<Tscal>>("dt_sph"),
                    solver_graph.get_edge_ptr<IDataEdge<Tscal>>("dt_force"),
                    solver_graph.get_edge_ptr<Indexes<u32>>("sizes"));
            }
...
template<class Tvec, template<class> class Kern>
void shammodels::sph::Solver<Tvec, Kern>::do_kick_substep(Tscal dt_sph) {
    ...
    utility.fields_forward_euler<Tvec>(ivxyz, iaxyz_sph, dt_sph / 2);
...
template<class Tvec, template<class> class Kern>
shammodels::sph::TimestepLog shammodels::sph::Solver<Tvec, Kern>::evolve_once_substep() {
    ...
    { // included in SolverGraph for now: leapfrog predictor, part killing
