...
namespace shammodels::gsph::modules {
     ...
     */
    struct IGSPHSetupNode_Dot {
        std::string name;
        u32 type;
        std::vector<IGSPHSetupNode_Dot> inputs;
    ...
    class IGSPHSetupNode {
         ...
         *
         * This function should return a IGSPHSetupNode_Dot object which contains
         * all the information needed to generate a dot graph for the node and
         * its children.
         *
         * @return A IGSPHSetupNode_Dot object
         */
        virtual IGSPHSetupNode_Dot get_dot_subgraph() = 0;

        /**
         * @brief Virtual destructor for the IGSPHSetupNode class
         */
        virtual ~IGSPHSetupNode() = default;
    ...
    /// Alias for a shared pointer to an IGSPHSetupNode
    using SetupNodePtr = std::shared_ptr<IGSPHSetupNode>;
