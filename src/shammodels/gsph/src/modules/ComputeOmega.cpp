            ...
            auto e = q.submit(depends_list, [&](sycl::handler &cgh) {
                ...
                shambase::parallel_for(cgh, cnt, "gsph_compute_density_omega", [=](u64 gid) {
                    ...
                    particle_looper.for_each_object(id_a, [&](u32 id_b) {
                        ...
                        // SPH density: rho_i = sum_j m_j * W(r_ij, h_i)
                        // Use neighbor's mass m_j for correct density computation
                        Tscal mass_b = has_pmass ? pmass_acc[id_b] : pmass;
                        rho_sum += mass_b * Kernel::W_3d(rab, h_a);
                        sumdWdh += mass_b * Kernel::dhW_3d(rab, h_a);
                    });
